...
* [이슈(Issue)에 대해 모두 알아보기](#이슈에-대해-모두-알아보기)
  * [이슈(Issue)란 무엇인가요?](#이슈란-무엇인가)
  * [이슈 템플릿(Issue Templates)](#이슈-템플릿)
    * [버그 발견](#버그-발견)
    * [기존 기능 향상](#기존-기능-향상)
    * [새로운 기능 요청](#새로운-기능-요청)
    * [토론(Discussion)](#토론discussion)
* [p5.js 코드베이스 작업](#p5js-코드베이스-작업)
  * [개발자를 위한 빠른 시작](#개발자를-위한-빠른-시작-가이드)
  * [Github 편집 기능 사용하기](#github-편집-기능-사용)
  * [p5.js를 포크하고 포크에서 작업하기](#p5js를-포크하고-자신의-포크fork에서-작업하기)
    * [Github Desktop 사용하기](#github-편집-기능-사용)
    * [git 명령줄(command line) 인터페이스 사용하기](#git-명령줄command-line-인터페이스-사용하기)
  * [코드베이스(code base) 분석](#코드베이스code-base-분석)
  * [빌드 설정](#빌드-설정)
  * [Git 워크플로우](#git-워크플로우)
    * [소스 코드](#소스-코드-source-code)
    * [단위 테스트](#단위-테스트-unit-tests)
    * [인라인 문서화](#인라인-문서-inline-documentation)
    * [국제화](https://github.com/processing/p5.js/blob/main/contributor_docs/contributor_guidelines.md#internationalization)
    * [접근성](#접근성-accessibility)
  * [코드 표준](#코드-표준)
  * [소프트웨어 디자인 원칙](#소프트웨어-디자인-원칙)
* [풀 리퀘스트](#풀-리퀘스트-pull-requests-pr)
  * [풀 리퀘스트 생성](#풀-리퀘스트-생성)
    * [풀 리퀘스트 정보](#풀-리퀘스트-정보)
    * [제목](#제목)
    * [해결](#해결)
    * [변경 사항](#변경-사항)
    * [변경 사항의 스크린샷](#변경-사항에-대한-스크린샷)
    * [풀 리퀘스트 체크리스트](#풀-리퀘스트-체크리스트)
    * [리베이스 및 충돌 해결](#리베이스-및-충돌-해결)
  * [논의 및 고치기(amend)](#논의-및-고치기amend)
...
1. *가장 적합한 p5.js 하위 영역은 무엇인가요?* -  이는 문제를 식별하고 응답하기 위해 이슈에 자동으로  [라벨(label)](https://github.com/processing/p5.js/blob/main/contributor_docs/issue_labels.md)태그를 지정하여 도와줍니다..
...
갓허브 데스크탑(GitHub Desktop)애서는 브랜치를 변경하는 버튼 오른쪽에 변경사항을 깃허브에 푸시하는 버튼이 있습니다. 버튼을 클릭하여 변경 사항을 푸시하세요.![A view of GitHub Desktop after committing changes. The button to push the changes online is circled in red.](src/content/contributor-docs/images/publish-branch.png)
...
가끔 깃허브는 'Resolve Conflicts' 버튼을 보여주면서 브라우저에서 직접 충돌을 해결할 수 있도록 합니다:![A screenshot of a GitHub pull request with merge conflicts. The conflicting filenames are listed, and there is a "Resolve conflicts" button highlighted.](src/content/contributor-docs/images/resolve-conflicts.png)
