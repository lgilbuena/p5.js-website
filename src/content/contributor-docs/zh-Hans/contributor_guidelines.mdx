...
如果你希望在 p5.js 代码库之外做出贡献（例如编写教程、规划教学课程、组织活动等），请查看其他相关页面。管理员或维护人员可以通过[管理员指南](../zh-Hans/contribute/steward_guidelines/)查阅问题审核与拉取请求相关的内容。
...
1. *p5.js 中与之最相关的子领域是？* - 回答该问题将触发自动标记功能，为问题打上相关的[标签](https://github.com/processing/p5.js/blob/main/contributor_docs/archive/issue_labels.md)，这有助于我们更好地识别和回应你的问题。
...
1. *提高无障碍性* - 这是一个必填项目，你需要在此处说明你建议加强的功能将会如何使得 p5.js 对于那些在创意和科技领域长期被边缘化的人群具备[更高的无障碍性](../zh-Hans/contribute/access/)。通常来讲，**如未填写此项，提案将被拒绝**。但你也可以填写“我不确定”，邀请社区的其他成员集思广益，帮你论证该增强功能可以怎样提高 p5.js 的无障碍性。
2. *p5.js 中最合适的子领域是什么？* - 这可以帮助我们锁定并回应你的问题。你的答复还将触发自动标记功能，使用相关的[标签](https://github.com/processing/p5.js/blob/main/contributor_docs/archive/issue_labels.md)标记该问题。
...
* [`test`](../zh-Hans/contribute/unit_testing/) - 存放单元测试代码和测试所有文档示例代码的位置。
...
如果你要进行单元测试，请参阅[这里](../zh-Hans/contribute/unit_testing/)。需要注意的是，对于任何功能强化、功能新增和错误修复，都应该在 PR 中添加相关的单元测试。
...
如果你要处理无障碍功能，请参阅[这里](../zh-Hans/contribute/web_accessibility/)。关于友好的错误系统，请参阅[这里](../zh-Hans/contribute/friendly_error_system/)。
